...
import ru.coderedwolf.wordlearn.ui.learn.phrases.LearnPhrasesFragment
import ru.coderedwolf.wordlearn.ui.learn.word.LearnWordsFragment
...
object Screens {
    ...
    object LearnWordsScreen : SupportAppScreen() {
        override fun getFragment(): Fragment = LearnWordsFragment()
    }
