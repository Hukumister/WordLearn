package ru.coderedwolf.wordlearn.wordflow.domain.interactor
...
class WordInteractorImpl @Inject constructor(
    ...
    override suspend fun findAllByCategoryId(categoryId: Long): List<Word> =
        wordRepository.findAllByCategoryId(categoryId)

    override suspend fun findAllPreviewByCategoryId(categoryId: Long): List<WordPreview> =
        wordRepository.findAllPreviewByCategoryId(categoryId)
}